/**
 * Banking Grid Controller
 * Handles banking grid interactions and NL query processing
 */
Ext.define('reExtAIDemo.view.ai.bankingGrid.DataGridController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.banking-grid-controller',
